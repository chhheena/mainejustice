...
class AdvancedModulesModelModule extends JModelAdmin
{
    ...
    public function initAssignments($id, &$module)
    {
        ...
        if ( ! isset($module->advancedparams['assignto_date']))
        {
            ...
            )
            {
                ...
                $module->advancedparams['assignto_date_publish_up']   = $module->publish_up ?? '';
                $module->advancedparams['assignto_date_publish_down'] = $module->publish_down ?? '';
    ...
    {
        $assignment = $advancedparams['assignto_menuitems'] ?? 0;
        $items      = $advancedparams['assignto_menuitems_selection'] ?? [];
