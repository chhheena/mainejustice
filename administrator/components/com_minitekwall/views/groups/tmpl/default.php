...
<form action="<?php echo JRoute::_('index.php?option=com_minitekwall&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php //echo $item->catid; ?>">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_minitekwall&task=group.edit&id=' . (int) $item->id); ?>">
