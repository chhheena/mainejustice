...
class Cache implements CacheInterface
{
	...
	public static function getCacheObject( $argtype = 'output' )
	{
		...
		{
			$cachebase = ( version_compare( JVERSION, '4.0', 'lt' ) ? JPATH_SITE : JPATH_ADMINISTRATOR ) . '/cache';
	...
	public static function deleteCache( $context = 'both' )
	{
		...
		if ( $context != 'plugin' )
		{
			//Get global cache object to clean page cache
			$oGlobalCache = Factory::getCache();
			$return       |= $oGlobalCache->clean( 'page' );
