...
use const PHP_SAPI;
final class Apcu extends AbstractAdapter implements AvailableSpaceCapableInterface, ClearByNamespaceInterface, ClearByPrefixInterface, FlushableInterface, IterableInterface, TotalSpaceCapableInterface
{
    /**
    ...
    protected function internalAddItem(&$normalizedKey, &$value)
    {
        ...
        if (!apcu_add($internalKey, $value, $ttl)) {
            ...
            $type = is_object($value) ? get_class($value) : gettype($value);
            throw new Exception\RuntimeException("apcu_add('{$internalKey}', <{$type}>, {$ttl}) failed");
        }
        return \true;
    }
    /**
    ...
    protected function internalGetCapabilities()
    {
        if ($this->capabilities === null) {
            $marker = new stdClass();
            $capabilities = new Capabilities($this, $marker, ['supportedDatatypes' => ['NULL' => \true, 'boolean' => \true, 'integer' => \true, 'double' => \true, 'string' => \true, 'array' => \true, 'object' => 'object', 'resource' => \false], 'supportedMetadata' => ['internal_key', 'atime', 'ctime', 'mtime', 'rtime', 'size', 'hits', 'ttl'], 'minTtl' => 1, 'maxTtl' => 0, 'staticTtl' => \true, 'ttlPrecision' => 1, 'useRequestTime' => (bool) ini_get('apc.use_request_time'), 'maxKeyLength' => 5182, 'namespaceIsPrefix' => \true, 'namespaceSeparator' => $this->getOptions()->getNamespaceSeparator()]);
