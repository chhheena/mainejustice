...
final class Redis extends AbstractAdapter implements ClearByNamespaceInterface, ClearByPrefixInterface, FlushableInterface, TotalSpaceCapableInterface
{
    /**
    ...
    protected function internalGetItems(array &$normalizedKeys)
    {
        ...
        return array_filter(array_combine($normalizedKeys, $results), function ($value) {
            return $value !== \false;
        });
    }
    /**
    ...
    protected function internalGetCapabilities()
    {
        if ($this->capabilities === null) {
            ...
            $this->capabilities = new Capabilities($this, $this->capabilityMarker, ['supportedDatatypes' => $serializer ? ['NULL' => \true, 'boolean' => \true, 'integer' => \true, 'double' => \true, 'string' => \true, 'array' => 'array', 'object' => 'object', 'resource' => \false] : ['NULL' => 'string', 'boolean' => 'string', 'integer' => 'string', 'double' => 'string', 'string' => \true, 'array' => \false, 'object' => \false, 'resource' => \false], 'supportedMetadata' => $supportedMetadata, 'minTtl' => $minTtl, 'maxTtl' => 0, 'staticTtl' => \true, 'ttlPrecision' => 1, 'useRequestTime' => \false, 'maxKeyLength' => $maxKeyLength, 'namespaceIsPrefix' => \true]);
        }
