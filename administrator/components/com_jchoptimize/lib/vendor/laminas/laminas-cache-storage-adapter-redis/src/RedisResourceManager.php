...
final class RedisResourceManager
{
    ...
    public function setResource($id, $resource)
    {
        ...
        if (!$resource instanceof RedisResource) {
            if ($resource instanceof Traversable) {
                ...
                throw new Exception\InvalidArgumentException('Resource must be an instance of an array or Traversable');
            }
    ...
    public function setPersistentId($id, $persistentId)
    {
        ...
        if ($resource['resource'] instanceof RedisResource && $resource['initialized']) {
            throw new Exception\RuntimeException("Can't change persistent id of resource {$id} after initialization");
        }
