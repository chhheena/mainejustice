...
use _JchOptimizeVendor\Laminas\Cache\Storage\Adapter\Exception\InvalidRedisClusterConfigurationException;
use Traversable;
final class RedisClusterOptions extends AdapterOptions
{
    public const LIBRARY_OPTIONS = [self::OPT_SERIALIZER, self::OPT_PREFIX, self::OPT_READ_TIMEOUT, self::OPT_SCAN, self::OPT_SLAVE_FAILOVER, self::OPT_TCP_KEEPALIVE, self::OPT_COMPRESSION, self::OPT_REPLY_LITERAL, self::OPT_COMPRESSION_LEVEL, self::OPT_NULL_MULTIBULK_AS_NULL];
