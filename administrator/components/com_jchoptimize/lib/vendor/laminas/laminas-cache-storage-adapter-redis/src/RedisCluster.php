...
use _JchOptimizeVendor\Laminas\Cache\Storage\Adapter\Exception\MetadataErrorException;
use _JchOptimizeVendor\Laminas\Cache\Storage\Adapter\Exception\RedisRuntimeException;
 ...
 */
final class RedisCluster extends AbstractAdapter implements ClearByNamespaceInterface, ClearByPrefixInterface, FlushableInterface
{
    ...
    public function flush() : bool
    {
        ...
        foreach ($masters as [$host, $port]) {
            ...
            $anyMasterSuccessfullyFlushed = \true;
        }
    ...
    protected function internalGetCapabilities() : Capabilities
    {
        ...
        $this->capabilities = new Capabilities($this, $this->capabilityMarker, ['supportedDatatypes' => $this->getSupportedDatatypes($serializer), 'supportedMetadata' => $supportedMetadata, 'minTtl' => $minTtl, 'maxTtl' => 0, 'staticTtl' => \true, 'ttlPrecision' => 1, 'useRequestTime' => \false, 'maxKeyLength' => $redisVersionLessThanV3 ? 255 : 512000000, 'namespaceIsPrefix' => \true]);
        return $this->capabilities;
    }
    /**
    ...
    {
        if ($serializer) {
            return ['NULL' => \true, 'boolean' => \true, 'integer' => \true, 'double' => \true, 'string' => \true, 'array' => 'array', 'object' => 'object', 'resource' => \false];
        }
        return ['NULL' => 'string', 'boolean' => 'string', 'integer' => 'string', 'double' => 'string', 'string' => \true, 'array' => \false, 'object' => \false, 'resource' => \false];
    }
    /**
    ...
    protected function internalGetMetadata(&$normalizedKey)
    {
        ...
        try {
            if (in_array('ttl', $capabilities->getSupportedMetadata(), \true)) {
    ...
    private function detectTtlForKey(RedisClusterFromExtension $redis, string $namespacedKey) : ?int
    {
        ...
        throw new Exception\LogicException(sprintf('%s must not be called for current redis version.', __METHOD__));
    }
