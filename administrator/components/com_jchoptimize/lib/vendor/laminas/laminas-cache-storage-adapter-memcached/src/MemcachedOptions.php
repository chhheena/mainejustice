...
class MemcachedOptions extends AdapterOptions
{
    ...
    {
        trigger_error('This method is deprecated and will be removed in the feature' . ', please use the resource manager instead', E_USER_DEPRECATED);
        $this->getResourceManager()->addServer($this->getResourceId(), ['host' => $host, 'port' => $port, 'weight' => $weight]);
        return $this;
    }
    /**
    ...
    {
        trigger_error('This method is deprecated and will be removed in the feature' . ', please use "lib_options" or the resource manager instead', E_USER_DEPRECATED);
