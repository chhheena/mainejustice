...
EOT;
    ...
    public function createFactory($className)
    {
        ...
        return sprintf(self::FACTORY_TEMPLATE, str_replace('\\' . $class, '', $className), $this->createImportStatements($className), $class, $class, $class, $this->createArgumentString($className));
    }
