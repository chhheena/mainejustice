...
class CommunityControllerMemberlist extends CommunityController
{
	...
	public function delete()
	{
		...
		{
			$this->setRedirect( 'index.php?option=com_community&view=memberlist' , JText::_('COM_COMMUNITY_MEMBERLIST_REMOVING_ERROR') , 'error' );
		}
		else
		{
			$this->setRedirect( 'index.php?option=com_community&view=memberlist' , JText::_('COM_COMMUNITY_MEMBERLIST_DELETED'),'message' );
		}
	}
}