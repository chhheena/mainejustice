...
class CommunityControllerThemegroups extends CommunityController
{
    ...
    public function apply()
    {
        ...
        {
            return $this->setRedirect( 'index.php?option=com_community&view=themegroups' , JText::_( 'COM_COMMUNITY_PERMISSION_DENIED' ) , 'error');
        }
        ...
        $settings = array();
        $images['default-cover-group']       = $jinput->files->get('default-cover-group' , '', 'NONE');
        $images['default-group-avatar']      = $jinput->files->get('default-group-avatar' , '', 'NONE');
        ...
        $helper->parseSettings($settings,'group');
        ...
        $this->setRedirect( 'index.php?option=com_community&view=themegroups' , $message, 'message' );
    }
}