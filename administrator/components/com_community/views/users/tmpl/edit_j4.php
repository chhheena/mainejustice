...
<form name="adminForm" id="profile-fields-form" action="index.php?option=com_community" method="POST" autocomplete="off">
    <div class="row-fluid">
        <?php echo HTMLHelper::_('uitab.startTabSet', 'profile-fields-tabs', array('startOffset' => 0)); ?>

        <?php echo HTMLHelper::_('uitab.addTab', 'profile-fields-tabs', 'details-page', Text::_('COM_COMMUNITY_USERS_ACCOUNT_DETAILS')) ?>
        <div class="span12">
            <table width="100%">
                <tr>
                    <td class="key">
        ...
        <?php $num = 0 ?>
        <?php foreach ($this->user->profile['fields'] as $group => $groupFields) : ?>
            <?php echo HTMLHelper::_('uitab.addTab', 'profile-fields-tabs', 'js-page-' . $num, Text::_($group)) ?>
            <table width="100%">
                <?php
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'profile-fields-tabs', 'setting-page', Text::_('COM_COMMUNITY_USERS_ACCOUNT_DETAILS')) ?>
        <div class="row-fluid">
            <div class='span12'>
                <table width='100%'>
                    <tr>
