...
<table  width="100%" class="paramlist admintable" cellspacing="1">
	...
	<tr>
		<td class="paramlist_key">
			<label for="pagerecentevents-admin" class="title">
				<span class="js-tooltip"  title="<?php echo JText::_('COM_COMMUNITY_PAGES_EVENT_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_PAGE_EVENTS');?></span>
			</label>
		</td>
		<td class="paramlist_value">
			<input type="text" name="pagerecentevents" id="pagerecentevents-admin" size="1" value="<?php echo $params->get('pagerecentevents', PAGE_EVENT_RECENT_LIMIT);?>" />
		</td>
	</tr>
    <tr>
        <td class="paramlist_key">
