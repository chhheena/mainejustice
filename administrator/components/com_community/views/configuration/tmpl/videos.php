			...
			<fieldset class="adminform">
				<table>
					<tbody>
						...
						<tr>
							<td class="key">
								<span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_VIDEOS_EXTENSIONS_TIPS'); ?>">
									<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_VIDEOS_EXTENSIONS' ); ?>
								</span>
							</td>
							<td>
								<input type="text" size="40" name="videoextensions" value="<?php echo $this->config->get('videoextensions', 'mp4');?>" />
							</td>
						</tr>
						<tr>
							<td class="key">
						...
						<tr>
							<td class="key">
								<span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_VIDEOS_THUMB_STREAM_SIZE_TIPS'); ?>">
									<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_VIDEOS_THUMB_STREAM_SIZE' ); ?>
								</span>
							</td>
							<td>
								<?php echo CHTMLInput::checkbox('enablevideosthumbbigsize' ,'ace-switch ace-switch-5', null , $this->config->get('enablevideosthumbbigsize') ); ?>
							</td>
						</tr>
						<tr>
							<td class="key">
