		...
		<div class="widget-main">
			<table>
				<tbody>
					...
					<tr>
						<td class="key">
							<span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_FEATURED_MAXIMUM_PAGES'); ?>">
								<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_FEATURED_MAXIMUM_PAGES' ); ?>
							</span>
						</td>
						<td>
							<input type="text" name="featuredpageslimit" value="<?php echo $this->config->get('featuredpageslimit' );?>" size="4" />
						</td>
					</tr>
					<tr>
						<td class="key">
