...
<table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td>
			<a href="<?php echo JRoute::_(JUri::root().'index.php?option=com_community&view=groups&task=viewgroup&groupid='.$row->id); ?>" target="_blank"><?php echo JText::_('COM_COMMUNITY_VIEW')?></a>
		</td>
	</tr>
	<?php endforeach; ?>
</table>
