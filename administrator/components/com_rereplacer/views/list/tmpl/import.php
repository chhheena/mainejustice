...
<form onsubmit="return submitform();"
    ...
    <fieldset class="form-horizontal">
        ...
        <div class="control-group">
            <label for="file" class="control-label"><?php echo JText::_('RR_CHOOSE_FILE'); ?></label>
        ...
        <div class="control-group">
            <label for="publish_all" class="control-label"><?php echo JText::_('RR_PUBLISH_ITEMS'); ?></label>
...
<script>
    ...
    function fileIsValid() {
        ...
        const valid_formats = ['json', 'xml', 'rrbak'];
