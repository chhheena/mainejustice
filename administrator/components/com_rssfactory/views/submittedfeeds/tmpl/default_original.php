...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminheading">
        <tr>
            <td style="width:30%">
                <?php echo JHTML::_('manageSources.refreshAllSourcesIcon'); ?>
                </span>
            </td>
            ...
            <td align="right" valign="top">
                <?php echo JHTML::_('manageSources.filterSearch'); ?>
            </td>
            <td align="right" valign="top">
                <?php echo JHTML::_('manageSources.filterCategory', $this->aCategories); ?>
            </td>
            <td align="right" valign="top">
                <?php echo JHTML::_('manageSources.filterPublished'); ?>
            </td>
            <td align="right" valign="top">
                <?php echo JHTML::_('manageSources.filterReset'); ?>
            </td>
        </tr>
    </table>
    <table class="adminlist">
        <tr>
            <th width="20" align="center">
                <input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo $nrRows; ?>);"/>
            </th>
            <th width="16px" nowrap="nowrap" align="left">
                Id:&nbsp;<?php echo JHTML::_('tooltip', 'Use this id for the replace plugin!'); ?>
            </th>
            <th width="5%" nowrap="nowrap" align="center"><?php echo JText::_('JPUBLISHED'); ?></th>
        ...
        foreach ($feedSources as $row) {
            ...
            <tr class="row<?php echo $k; ?>">
                <td align="center">
                    <?php echo JHTML::_('grid.id', $i, $row->id, false); ?>
                </td>
                <td align="center">
                    <?php echo $row->id; ?>
                </td>
                <td align="center">
                    <?php echo JHTML::_('grid.published', $row->published, $i); ?>
                </td>
                ...
                <td>
                    <?php echo JHTML::_('manageSources.createSiteIco', $row); ?>
                </td>
                <td>
                    <a href="index.php?option=<?php echo $option . '&task=editSourceFeed&id=' . $row->id; ?>"><?php echo $row->title; ?></a>
                </td>
                <td>
                    <?php echo JHTML::_('manageSources.stringCategoryName', $row); ?>
                </td>
                <td style="text-align: right;">
                    <?php echo JHTML::_('manageSources.refreshSourceIcon', $row); ?>
                </td>
                <td>
                    <?php echo JHTML::_('manageSources.sourceLocation', $row) ?>
                </td>
                <td>
                    <span id="refreshDate_<?php echo $row->id ?>"><?php echo $row->date; ?></span>
                </td>
                <td style="text-align: center;">
                    <?php echo JHTML::_('manageSources.refreshError', $row); ?>
                </td>
            </tr>
            <?php
            $k = 1 - $k;
