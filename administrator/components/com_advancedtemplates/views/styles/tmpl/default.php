...
<form action="<?php echo JRoute::_('index.php?option=com_advancedtemplates'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		{
			echo RL_Version::getMessage('ADVANCEDTEMPLATEMANAGER');
		}
		?>
					...
					<tr>
						...
						<?php if ($showcolors) : ?>
							...
							<th width="1%" class="nowrap center hidden-phone">
								<?php echo JHtml::_('grid.sort', '<span class="icon-color"></span>', 'color', $listDirn, $listOrder, null, 'asc', 'RL_COLOR'); ?>
							</th>
						<?php endif; ?>
						<th width="5">
							&#160;
		...
		echo RL_License::getMessage('ADVANCEDTEMPLATEMANAGER');

		// Copyright
		echo RL_Version::getFooter('ADVANCEDTEMPLATEMANAGER');
		?>
	</div>
</form>
