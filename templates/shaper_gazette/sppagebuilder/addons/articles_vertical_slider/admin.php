...
SpAddonsConfig::addonConfig(
	array( 
		'type'=>'content',
		'addon_name'=>'sp_articles_vertical_slider',
		'category'=>'Gazette',
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_VERTICAL_SLIDER'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_VERTICAL_SLIDER_DESC'),
		'attr'=>array(
			'admin_label'=>array(
					'type'=>'text', 
