...
array(
	...
	'attr'=>array(
		'general' => array(
			...
			'article_layouts'=>array(
				'type'=>'select',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS'),
				'values'=>array(
					'default'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_DEFAULT'),
					'classic'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_CLASSIC'),
					'simple'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_SIMPLE'),
					'modern'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_MODERN'),
					'creative'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_CREATIVE'),
					'standard'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_STANDARD'),
					'essential'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_ESSENTIAL'),
					'horizontal'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_HORIZONTAL'),
					'masonry'=> JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LAYOUTS_MASONRY'),
				),
				'std'=>'default',
			),
			'border_style'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_BORDER_STYLE'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_BORDER_STYLE_DESC'),
				'std'=>1,
			),
			'title'=>array(
				'type'=>'text',
			...
			'lazyestload'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_LAZYESTLOAD'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_LAZYESTLOAD_DESC'),
				'std'=> 0,
			),

			'scroller'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_SCROLLER'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_SCROLLER_DESC'),
				'std'=> 0,
			),

			'article_height'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_SCROLLER_HEIGHT'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ITEMS_SCROLLER_HEIGHT_DESC'),
				'placeholder'=>'100',
				'max'=>1000,
				'depends'=>array(array('scroller', '=', 1)),
			),

			'intro_scroller'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_INTRO_SCROLLER'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_INTRO_SCROLLER_DESC'),
				'std'=> 0,
			),

			'article_intros_height'=>array(
				'type'=>'slider',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLE_INTRO_SCROLLER_HEIGHT'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLE_INTRO_SCROLLER_HEIGHT_DESC'),
				'placeholder'=>'100',
				'max'=>1000,
				'depends'=>array(array('intro_scroller', '=', 1)),
			),

			'articles_bd_top'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ARTICLES_BORDER_TOP'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ARTICLES_BORDER_TOP_DESC'),
				'std'=> 0,
			),
			'articles_bd_top_color'=>array(
				'type'=>'color',
				'title'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_GLOBAL_COLOR_DESC'),
				'std' => '#fff',
				'depends'=>array(array('articles_bd_top', '=', 1)),
			),
			'resource'=>array(
				'type'=>'select',
			...
			'leading_columns'=>array(
				'type'=>'number',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LEADING_COLUMNS'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_LEADING_COLUMNS_DESC'),
				'std'=>'12',
			),
			'intro_columns'=>array(
				'type'=>'number',
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_INTRO_COLUMNS'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_INTRO_COLUMNS_DESC'),
				'std'=>'0',
			),
