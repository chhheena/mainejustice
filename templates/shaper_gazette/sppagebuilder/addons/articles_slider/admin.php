	...
	array( 
		...
		'attr'=>array(
			...
			'hide_thumbnail'=>array(
				...
				'std'=>0,
				'depends'=>array(array('slider_style', '!=', 'bg_image'))
				),
			...
			'slider_style'=>array(
				'type'=>'select', 
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_STYLE'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_STYLE_DESC'),
				'values'=>array(
					'default'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_STYLE_DEFAULT'),
					'bg_image'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_STYLE_BG_IMAGE')
					),
				'std'=>'default',
				),
			...
			'article_items'=>array(
				'type'=>'number', 
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ARTICLES_ITEM'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_ARTICLES_ITEM_DESC'),
				'std'=>'',
			),
			...
			'items_gutter'=>array(
				'type'=>'number', 
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_ITEMS_GUTTER'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_ITEMS_GUTTER_DESC'),
				'std'=>'30',
			),
			'arrows'=>array(
				'type'=>'select', 
				'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_SHOW_ARROWS'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_SLIDER_SHOW_ARROWS_DESC'),
				'values'=>array(
					1=>JText::_('JYES'),
					0=>JText::_('JNO'),
					),
