            ...
            <div class="sp-weather-icon-wrap">
                ...
                <?php if($params->get('wind')==1) { ?>
                    <div class="spw_row">
                        ...
                        if ($platform == 'apixu') {
                            $data['wind']['direction'] = (isset($data['wind']['direction']) && $data['wind']['direction']) ? $data['wind']['direction'] . Text::_('SP_WEATHER_AT') : '';
                        } else {
    ...
    <div class="sp-weather-forcasts layout-<?php echo $params->get('tmpl_layout', ''); ?>">
        ...
        foreach($forecast as $i=>$value ) {
            if ($platform == 'apixu') {
                ...
                $weather_date   = $helper->txt2lng(HTMLHelper::date($value->date_epoch, 'D'));
