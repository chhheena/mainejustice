...
<div class="sp-tweet nano">
	...
	<div class="sp-tweet-clr"></div>
	<?php if ($follow_us) { ?>
		<a class="followme" target="<?php echo $target ?>" href="http://twitter.com/<?php echo $data[0]['user']['screen_name'] ?>"><?php echo Text::_('FOLLOW') . ' ' . $data[0]['user']['name'] . ' ' . Text::_('ON_TWITTER') ?></a>
	<?php } ?>
	<div class="sp-tweet-clr"></div>