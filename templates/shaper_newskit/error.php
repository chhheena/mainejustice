					...
					<div>
						<div class="row">
							<div class="col-sm-3 col-sm-offset-2">
								<img src="<?php echo JURI::root(); ?>images/demo/error.png" alt="error">
							</div>
							<div class="col-sm-5 text-left content-wrap">
								<h1 class="error-code"><?php echo $this->error->getCode(); ?></h1>
								<p class="error-message"><?php echo $this->error->getMessage(); ?></p>
								<a class="btn btn-default" href="<?php echo $this->baseurl; ?>/" title="<?php echo JText::_('HOME'); ?>"> <?php echo JText::_('HELIX_GO_BACK'); ?></a>
