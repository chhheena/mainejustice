        ...
        <?php if ($params->get('animation') == 'none') { ?>
            ...
            <?php } else { ?>
                ...
                <?php if ($avatar) { ?>
                    ...
                    <?php } ?>
                <?php } ?>
                <div class="mod-tweet-content-wrap">
                    <div class="twitter-username">
                        <?php echo $value['user']['name'] ?>
                        <a href="http://twitter.com/<?php echo $value['user']['screen_name'] ?>">@<?php echo $value['user']['screen_name'] ?></a>
                    </div>
                    <?php if ($tweet_time) { ?>
                        <?php if ($tweet_time_linked) { ?>
                            <div class="date"><a target="<?php echo $target ?>" href="http://twitter.com/<?php echo $value['user']['screen_name'] ?>/status/<?php echo $value['id_str'] ?>"><?php echo JText::_('ABOUT') . '&nbsp;' . $helper->timeago($value['created_at']) . '&nbsp;' . JText::_('AGO'); ?></a></div>
                        <?php } else { ?>
