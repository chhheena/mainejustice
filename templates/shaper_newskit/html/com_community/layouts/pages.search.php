...
?>
<div class="joms-page">
    <h3 class="joms-page__title"><?php echo JText::_('COM_COMMUNITY_PAGES_SEARCH_TITLE'); ?></h3>
    <?php echo $submenu; ?>
		...
		<div class="joms-form__group">
			<span class="big">
				<select name="catid" id="catid" class="joms-select" >
					<option value="0" selected><?php echo JText::_('COM_COMMUNITY_PAGES_CATEGORY_TIPS');?></option>
					<?php
			...
			<input type="text" id="q" class="joms-input" name="search" value="<?php echo $this->escape($search); ?>"  placeholder="<?php echo JText::_('COM_COMMUNITY_SEARCH_PAGE_PLACEHOLDER');?>" />
		</div>
...
<div class="joms-page">
	<h3 class="joms-page__title">
		<?php echo JText::sprintf( 'COM_COMMUNITY_PAGES_SEARCH_RESULT' , $search ); ?>
	</h3>

	<div class="joms-form__group">
		<p>
			<?php echo JText::sprintf( (CStringHelper::isPlural($pagesCount)) ? 'COM_COMMUNITY_PAGES_SEARCH_RESULT_TOTAL_MANY' : 'COM_COMMUNITY_PAGES_SEARCH_RESULT_TOTAL' , $pagesCount ); ?>
		</p>
	</div>
