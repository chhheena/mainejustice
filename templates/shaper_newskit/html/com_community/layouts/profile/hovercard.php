        ...
        <div class="joms-hcard__actions">
            ...
            <?php if ( $isFriend ) { ?>
                ...
                <?php if ($loggedIn && $config->get('enablefollowers')) { ?>
                    <?php if (!$isFollowing) { ?>
                        <a href="javascript:" class="joms-button--neutral joms-button--small" onclick="joms.api.followAdd('<?php echo $profile->id;?>')">
                            <?php echo JText::_('COM_COMMUNITY_FOLLOW'); ?>
                        </a>
                    <?php } else { ?>
                        <a href="javascript:" class="joms-button--neutral joms-button--small" onclick="joms.api.followRemove('<?php echo $profile->id;?>')">
            ...
            <?php } else if ( !$isBlocked ) { ?>
                ...
                <?php } else if (CFactory::getUser()->authorise('community.request', 'friends.' . $profile->id)) { ?>
                    <a href="javascript:" class="joms-button--neutral joms-button--small" onclick="joms.api.friendAdd('<?php echo $profile->id;?>')">
