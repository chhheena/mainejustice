...
<div>
    <div class="joms-stream__header" style="padding:0">
        <div class="joms-avatar--stream">
            <img src="<?php echo $userInfo['profile']; ?>" alt="<?php echo $userInfo['name']; ?>" >
        </div>
        <div class="joms-stream__meta">
            <span><?php echo JText::sprintf('COM_COMMUNITY_LINKEDIN_CONNECT_DESCRIPTION', $userInfo['name']); ?></span>
        </div>
    </div>
</div>
    ...
    <div class="joms-form__group" style="margin-top:15px; color:inherit">
        ...
        <div>
            <label for="joms-js--fbc-existing" style="font-size:inherit">
                ...
                <p class="joms-help"><?php echo JText::_('COM_COMMUNITY_LINKEDIN_EXISTING_SITE_MEMBER_DESCRIPTION'); ?></p>
            </label>
        </div>
    </div>
                ...
                <label for="joms-js--fbc-tnc-checkbox" style="font-size:inherit; margin:0">
                    <?php
                        if ($config->get('enableterms') && !$config->get('enablegdpr')) {
                            ...
                            echo JText::sprintf('COM_COMMUNITY_I_AGREE_GDPR_LINKEDIN', $sitename);
                        }  else if ($config->get('enableterms') && $config->get('enablegdpr')) {
                            echo JText::_('COM_COMMUNITY_I_HAVE_READ') . ' <a href="javascript:" class="joms-js--fbc-tnc-toggle">' . JText::_('COM_COMMUNITY_TERMS_AND_CONDITION') . '</a>. ';
                            echo JText::sprintf('COM_COMMUNITY_I_AGREE_GDPR_LINKEDIN_AND', $sitename);
                        }
                    ?>
                </label>
