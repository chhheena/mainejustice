        ...
        <?php if ($members): ?>
            ...
            <ul class="joms-list--friend">
                <?php foreach ($members as $member) { ?>
                    ...
                    ?>
                    <li id="member_<?php echo $member->id; ?>" class="joms-list__item joms-js--member-page-<?php echo $pageid; ?>-<?php echo $member->id; ?>">
                        ...
                        <div class="joms-list__body">
                            ...
                            <div class="joms-js--request-notice-page-<?php echo $pageid; ?>-<?php echo $member->id; ?>"></div>
                            <div class="joms-js--request-buttons-page-<?php echo $pageid; ?>-<?php echo $member->id; ?>" style="white-space:nowrap">
                                <a href="javascript:" onclick="joms.api.pageApprove('<?php echo $pageid; ?>', '<?php echo $member->id; ?>');">
                                    <button class="joms-button--primary joms-button--smallest"><?php echo JText::_('COM_COMMUNITY_PENDING_ACTION_APPROVE'); ?></button>
                                </a>
                                <a href="javascript:" onclick="joms.api.pageRemoveMember('<?php echo $pageid; ?>', '<?php echo $member->id; ?>');">
                        ...
                        <div class="joms-list__actions">
                            <?php echo CFriendsHelper::getUserCog($member->id,null,null,$pageid,true); ?>
