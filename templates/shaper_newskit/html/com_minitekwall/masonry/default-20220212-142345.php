...
<div id="mnwall_container_<?php echo $this->widgetID;
							...
							<?php
							echo $this->mnwall_grid; ?> 
							<?php
							echo $suffix; ?>" data-order="<?php echo $this->active_ordering;
	...
	?><div id="mnwall_iso_container_<?php echo $this->widgetID;
									?>" class="mnwall_iso_container" style="margin: -<?php echo (int)$this->gutter; ?>px;">
		<?php
	...
	?><div class="mnwall_arrows">
			<a href="#" class="mnwall_arrow mnwall_arrow_prev disabled" data-page="0" title="<?php echo JText::_('COM_MINITEKWALL_PREVIOUS_PAGE'); ?>">
				<span class="more-results">
					<?php
					if ($this->arrows !== 'text') {
					?><i class="fa fa-<?php echo $this->arrows; ?>-left"></i>
					<?php
					} else {
			...
			?><a href="#" class="mnwall_arrow mnwall_arrow_next <?php echo $next_class; ?>" data-page="2" title="<?php echo JText::_('COM_MINITEKWALL_NEXT_PAGE'); ?>">
				<span class="more-results">
					<?php
					if ($this->arrows !== 'text') {
					?><i class="fa fa-<?php echo $this->arrows; ?>-right"></i>
					<?php
					} else {
