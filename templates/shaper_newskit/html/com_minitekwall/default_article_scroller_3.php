		...
		?><div class="mnwall-scr-item <?php 
			...
			?><div class="mnwall-scr-item-outer-cont" style="<?php echo $this->animated_flip; ?>">
				<div class="mnwall-scr-item-inner-cont" style="<?php 
					...
					{
						?><div class="mnwall-scr-cover <?php 
							echo $this->hoverEffectClass; 
							if (!$this->detailBox) 
							{
								echo ' no_detail_box';
							} 
							?>" style="height: <?php echo $this->scr_image_height; ?>px;"><?php 
										...
										?><div class="mnwall-hover-box-content <?php echo $this->hoverTextColor; ?>"><?php 
											...
											if ($this->hoverBoxTitle) 
											{
												?><h3 class="mnwall-title"><?php 
													...
													{
														?>{modal  href="<?php echo $item->itemLink; ?>"}<?php 
					...
					if ($this->detailBox) 
					{
						?><div class="mnwall-scr-detail-box clearfix <?php 
				...
				if ($this->hoverBox && ((! $this->scr_images || !isset($item->itemImage) || !$item->itemImage) || ($this->hoverBoxEffect == '2' || $this->hoverBoxEffect == '3'))) 
				{
					?><div class="mnwall-hover-box" style="<?php 
						echo $this->animated; 
						?> background-color: rgba(<?php echo $this->hb_bg_class; ?>,<?php echo $this->hb_bg_opacity_class; ?>); <?php 
