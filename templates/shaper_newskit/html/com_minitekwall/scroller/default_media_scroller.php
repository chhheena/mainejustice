...
if (!empty($this->wall) ||  $this->wall!== 0)
{
	foreach ($this->wall as $key=>$item)
	{
		if (isset($item->itemImage) && $item->itemImage && $this->scr_images) 
		{
			?><div class="mnwall-scr-item <?php 
				...
				?><div class="mnwall-scr-item-outer-cont" style="<?php echo $this->animated_flip; ?>">
					<div class="mnwall-scr-item-inner-cont" style="<?php 
						...
						?><div class="mnwall-scr-cover <?php echo $this->hoverEffectClass; ?>">
							<div class="mnwall-scr-img-div" style="<?php echo $this->animated_flip; ?>">
								<div class="mnwall-scr-item-img"><?php 
									if (isset($item->itemLink) && $this->scr_image_link) 
									{
										?><a href="<?php echo $item->itemLink; ?>" target="_blank" class="mnwall-scr-photo-link">
							...
							?><div class="mnwall-hover-box-content <?php echo $this->hoverTextColor; ?>"><?php 
								...
								if ($this->hoverBoxTitle) 
								{
									?><h3 class="mnwall-title"><?php 
										...
										{
											?><a href="<?php echo $item->itemLink; ?>" target="_blank"><?php><?php 
								...
								if ($this->hoverBoxLinkButton || $this->hoverBoxLightboxButton) 
								{
									?><div class="mnwall-item-icons"><?php 
										...
										if ($this->hoverBoxLightboxButton) 
										{
	...
	?><div class="mnwall-scr-media-db"><?php 
		foreach ($this->wall as $key=>$item)
		{
			if (isset($item->itemImage) && $item->itemImage && $this->scr_images) 
			{
				if ($this->detailBox) 
				{
					?><div class="mnwall-scr-detail-box <?php 
						...
						?>" style="background-color: rgba(<?php 
							echo $this->detailBoxBackground; ?>,<?php 
							echo $this->detailBoxBackgroundOpacity; 
						?>);" data-selectedindex=""><?php 
						...
						if ($this->detailBoxReadmore) 
						{
							if (isset($item->itemLink)) 
							{
								?><div class="mnwall-readmore">
									<a href="<?php echo $item->itemLink; ?>" target="_blank"><?php echo JText::_('COM_MINITEKWALL_READ_MORE'); ?></a>
								</div><?php 
							}
						}
					?></div><?php 
