			...
			?><div class="mnwall-item-outer-cont <?php 
				...
				?><div class="mnwall-item-inner-cont"><?php 
					if (isset($item->itemImage) && $item->itemImage && $this->mas_images) 
					{
						...
						{
							?><a href="<?php echo $item->itemLink; ?>" target="_blank" class="mnwall-photo-link" style="background-image: url('<?php echo $item->itemImage; ?>');"></a><?php 
						} 
						else 
						{
						...
						?><div class="mnwall-item-inner mnwall-detail-box <?php 
							...
							if ($this->detailBoxTitleAll) 
							{
								?><h3 class="mnwall-title"><?php 
									...
									{
										?>
										<a target="_blank" href="<?= $item->itemLink ?>"class="">
										<?php 
											echo $item->itemTitle; 
										?>
									</a>
									
										<!-- <a href="<?php //echo $item->itemLink; ?>" class="modal_link rl_modals_element" data-modal-iframe="true" data-modal-inner-width="95%" data-modal-inner-height="95%" data-modal-class-name="no_title"><?php 
											///echo $item->itemTitle; 
										?></a> -->
										<?php 
									} 
								...
								<!-- <div class="modal fade" id="exampleModal<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											...
											<div class="modal-body">
												<iframe  class="modal_frame" src="<?php echo $item->itemLink; ?>" frameborder="0"></iframe>
											</div>
											</div>
										</div>
									</div> -->
						...
						?><div class="mnwall-hover-box-content <?php echo $this->hoverTextColor; ?>"><?php 
							...
							if ($this->hoverBoxTitle) 
							{
								?><h3 class="mnwall-title"><?php 
									if (isset($item->itemLink) && $this->detailBoxTitleLink) 
									{ ?>
										<!-- <a class="" data-toggle="modal" data-target="#exampleModal1<?php echo $key; ?>"> -->
										<a class="" target="_blank" href="<?php echo $item->itemLink; ?>">
										<?php 
											echo $item->itemTitle; 
										?>
										</a>
								...
								<!-- <div class="modal fade" id="exampleModal1<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-label="Close">
