...
$menu_class = '';
if(isset($menu) && $menu){
    // get active menu page class
    $menu_class = $menu->params->get('pageclass_sfx');
}
...
// include page class
if (isset($menu_class) && $menu_class) {
  $body_classes .= ' ' . $menu_class;
}
    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, newskit.css') // CSS Files
