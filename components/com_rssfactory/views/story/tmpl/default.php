...
<?php if ($this->user->authorise('frontend.comment.view', 'com_rssfactory')): ?>
...
<a href="<?php echo $this->story->item_link; ?>" class="btn" target="_blank">
    <?php echo JText::_('COM_RSSFACTORY_FEED_STORY_DISPLAY_READ_MORE'); ?>
</a>
