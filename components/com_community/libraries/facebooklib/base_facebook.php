 ...
 *
 * @license Licensed under the Apache License, Version 2.0 (the "License"); you may
...
abstract class BaseFacebook
{
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
    ...
    if (json_last_error() === 0 && isset($response->access_token) && !empty($response->access_token)) {
      $response_params['access_token'] = $response->access_token;
    } else {
      parse_str($access_token_response, $response_params);
      if (!isset($response_params['access_token'])) {
        return false;
