...
<?php if(isset($pageMiniHeader) && $pageMiniHeader){ ?>
<div class="joms-body">
    <?php echo $pageMiniHeader; ?>
</div>
<?php } ?>
            ...
            <button onclick="window.location='<?php echo $createLink; ?>';" class="joms-button--add">
                <?php 
                    if (isset($isGroup) && $isGroup) {
                        echo JText::_('COM_COMMUNITY_CREATE_GROUP_EVENT');
                    } else if (isset($isPage) && $isPage) {
                        echo JText::_('COM_COMMUNITY_CREATE_PAGE_EVENT');
                    } else {
                        echo JText::_('COM_COMMUNITY_CREATE_EVENT'); 
                    }
                ?>
