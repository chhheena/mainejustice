...
class CTablePageMembers extends JTable
{
	var $pageid		= null;
	var $memberid		= null;
	var $approved		= null;
	...
	{
		parent::__construct( '#__community_pages_members', 'id', $db );
	}
	...
	public function store($updateNulls = false)
	{
		...
		if( !$this->exists() )
		{
			...
			return $db->insertObject( '#__community_pages_members' , $data );
		}
		else
		{
			$query	= 'UPDATE ' . $db->quoteName( '#__community_pages_members' ) . ' '
	...
	public function approve()
	{
		...
		$query	= 'UPDATE ' . $db->quoteName( '#__community_pages_members' ) . ' SET '
