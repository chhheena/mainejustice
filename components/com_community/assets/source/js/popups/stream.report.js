...
var popup, elem, id, commentid;

function render( _popup, _id, _commentid ) {
    if ( elem ) elem.off();
    popup = _popup;
    id = _id;
...
function save() {
    ...
    joms.ajax({
        ...
        data: [ 'activities,reportActivities', window.location.href, message, id, commentid ],
        callback: function( json ) {
...
// Exports.
return function( id, commentid ) {
    joms.util.popup.prepare(function( mfp ) {
        render( mfp, id, commentid );
    });
};
