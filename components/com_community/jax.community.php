<?php
    ...
    $jaxFuncNames[] = 'system,ajaxLoadPageEventMembers';
    $jaxFuncNames[] = 'system,ajaxRate';
    ...
    /** followers**/
    $jaxFuncNames[] = 'followers,ajaxConfirmFollow';
    $jaxFuncNames[] = 'followers,ajaxSaveFollow';
    $jaxFuncNames[] = 'followers,ajaxConfirmUnfollow';
    $jaxFuncNames[] = 'followers,ajaxUnfollowSave';
    ...
    $jaxFuncNames[] = 'pages,ajaxShowUnpublishPage';
    $jaxFuncNames[] = 'pages,ajaxDeletePage';
    $jaxFuncNames[] = 'pages,ajaxWarnPageDeletion';
    $jaxFuncNames[] = 'pages,ajaxAddFeatured';
    $jaxFuncNames[] = 'pages,ajaxRemoveFeatured';
    $jaxFuncNames[] = 'pages,ajaxAddAdmin';
    $jaxFuncNames[] = 'pages,ajaxRemoveAdmin';
    $jaxFuncNames[] = 'pages,ajaxConfirmMemberRemoval';
    $jaxFuncNames[] = 'pages,ajaxRemoveMember';
    $jaxFuncNames[] = 'pages,ajaxBanMember';
    $jaxFuncNames[] = 'pages,ajaxUnbanMember';
    $jaxFuncNames[] = 'pages,ajaxUpdateCount';
    $jaxFuncNames[] = 'pages,ajaxShowGroupFeatured';
    $jaxFuncNames[] = 'pages,ajaxRejectInvitation';
    $jaxFuncNames[] = 'pages,ajaxAcceptInvitation';
    ...
    $jaxFuncNames[] = 'notification,ajaxPageJoinInvitation';
    $jaxFuncNames[] = 'notification,ajaxPageRejectInvitation';
    ...
    $jaxFuncNames[] = 'events,ajaxShowUnpublishEvent';
    $jaxFuncNames[] = 'events,ajaxUnpublishEvent';
    ...
    $jaxFuncNames[] = 'admin,profiles,ajaxSortField';
    ...
    $jaxFuncNames[] = 'admin,pagecategories,ajaxEditCategory';
    $jaxFuncNames[] = 'admin,pagecategories,ajaxSaveCategory';
    ...
    $jaxFuncNames[] = 'admin,multiprofile,ajaxSortField';
    ...
    $jaxFuncNames[] = 'admin,pages,ajaxEditPage';
    $jaxFuncNames[] = 'admin,pages,ajaxChangePageOwner';
    $jaxFuncNames[] = 'admin,pages,ajaxTogglePublish';
    ...
    $jaxFuncNames[] = 'admin,pendinginvites,ajaxPerformAction';
    ...
    $jaxFuncNames[] = 'admin,troubleshoots,ajaxCleanChatOrphaned';
    ...
    // @since 4.3
    $jaxFuncNames[] = 'system,ajaxSaveWall';
    $jaxFuncNames[] = 'system,ajaxLogin';

    // @for chat
    $jaxFuncNames[] = 'chat,ajaxPingChat';
    $jaxFuncNames[] = 'chat,ajaxSeen';
    $jaxFuncNames[] = 'chat,ajaxPrivateMessageSend';
    $jaxFuncNames[] = 'chat,ajaxInitializeChatData';
    $jaxFuncNames[] = 'chat,ajaxGetChatList';
    $jaxFuncNames[] = 'chat,ajaxGetSingleChatByUser';
    $jaxFuncNames[] = 'chat,ajaxAddChat';
    $jaxFuncNames[] = 'chat,ajaxGetLastChat';
    $jaxFuncNames[] = 'chat,ajaxLeaveChat';
    $jaxFuncNames[] = 'chat,ajaxAddPeople';
    $jaxFuncNames[] = 'chat,ajaxGetFriendListByName';
    $jaxFuncNames[] = 'chat,ajaxMuteChat';
    $jaxFuncNames[] = 'chat,ajaxDisableChat';
    $jaxFuncNames[] = 'chat,ajaxRecallMessage';
    $jaxFuncNames[] = 'chat,ajaxGetLatestActivities';
    ...
    // @since 4.6
    $jaxFuncNames[] = 'system,ajaxShowReactedUsers';
    $jaxFuncNames[] = 'system,ajaxGetUsersByReaction';
    ...
    if (!CStringHelper::stristr(JPATH_COMPONENT, 'administrator/components/com_community')
        && !CStringHelper::stristr(JPATH_COMPONENT, 'administrator\components\com_community')
    ) {
